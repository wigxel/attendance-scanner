...
function getComfortTooltipKey(
  comfort: ComfortResult,
): keyof typeof COMFORT_TOOLTIPS {
...
export function InsightsSection() {
  const liveBucket = useQuery(api.roomMetrics.getLiveReading, {
    roomId: "all",
  });
    ...
    <TooltipProvider delayDuration={200}>
      <div className="grid grid-cols-5 gap-4">
        ...
        <Card className="aspect-3/1.2">
          ...
          <CardContent className="px-4 pb-4 text-xs text-muted-foreground">
            depression {depression.toFixed(1)}°C · Td {dewPointValue.toFixed(1)}
            °C
          </CardContent>
        </Card>
      </div>
