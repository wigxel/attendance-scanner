    ...
    <section className="w-full h-screen flex justify-center items-center p-4 xl:p-0">
      ...
      <div className="w-full sm:w-[335px] h-[812px] flex flex-col gap-8 justify-center items-center">
        ...
        <div className="w-full h-fit  flex  flex-col mt-32">
          ...
          <a
            href="/guest"
            className="w-full h-8 text-xs font-semibold border-2 flex justify-center items-center border-(--button-gray) bg-white text-black hover:bg-(--button-gray) rounded-sm mb-4"
          >
            Continue as a Guest
          </a>
          {/* user button */}
          <a
            href="/userLogin"
            className="w-full h-8 text-xs font-semibold flex justify-center items-center  bg-(--button-gray) text-black hover:bg-gray-300 rounded-sm"
          >
            Continue as a User
          </a>
        </div>
