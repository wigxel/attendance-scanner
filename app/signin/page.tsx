...
export default function SignIn() {
  ...
  return (
    <div className="w-full h-full relative">
      {/* github logo icon */}
      <nav className="w-full h-20 absolute flex justify-end items-center px-4">

        <a href="https://github.com/wigxel/attendance-scanner" target="_blank" className="p-2 rounded-full bg-gray-100">
