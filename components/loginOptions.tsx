    ...
    <section className="w-full h-screen flex justify-center items-center p-4 xl:p-0">
      ...
      <div className="w-full lg:w-[335px] h-[812px] flex flex-col gap-8 justify-center items-center">
        ...
        <div className="w-full h-fit mt-32">
          <button type="submit" className="w-full h-8 text-xs font-semibold border-2 border-(--button-gray) bg-white text-black hover:bg-(--button-gray) rounded-sm mb-4">Continue as a Guest</button>
          <button type="submit" className="w-full h-8 text-xs font-semibold  bg-(--button-gray) text-black hover:bg-gray-300 rounded-sm">Continue as a User</button>
        </div>
