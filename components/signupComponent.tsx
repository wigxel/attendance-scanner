  ...
  return (
    <div className="w-full sm:w-[335px] h-[812px] flex flex-col justify-center items-center">
        ...
        <header className="w-full h-fit flex flex-col justify-center items-center">
            <h3 className="text-2xl">Hello, Curious One <span className="text-lg font-light">&#x1F44B;</span></h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='mt-24 mb-4'>
            ...
            <button type="submit" className="w-full h-8 text-xs font-semibold bg-(--button-gray) text-black hover:bg-gray-300 rounded-sm">Sign Up and Continue</button>
        </form>

        <div className='w-full flex justify-start items-center'>
            <span className='text-sm font-normal'>Already have an account? </span>
            <a href="#" className="text-sm font-normal ml-2 underline hover:text-blue-500 cursor-pointer">Log in</a>
        </div>
