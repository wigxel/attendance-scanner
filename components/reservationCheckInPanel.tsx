    ...
    <section className="w-full h-screen flex justify-center items-center p-4 xl:!p-6">
      ...
      <div className="w-full sm:max-w-[335px] h-[812px] flex flex-col justify-center items-center">
        ...
        <header className="w-full h-fit flex flex-col justify-center items-start">
          ...
          <h1 className="text-2xl font-semibold my-2 subpixel-antialiased">
            Welcome Back
          </h1>
        </header>
        ...
        >
          ...
          {/* QR code footer */}
          <p className="text-xs text-(--text-gray) font-medium mt-4">
        ...
        <div className="w-full h-fit mt-6">
          <div className="w-full sm:w-[335px] h-[232px] flex flex-col justify-center rounded-lg bg-(--background-gray) px-6 py-12 mb-4">
            {/* header text */}
            <h1 className="font-semibold text-base">Code. Create. Launch</h1>
            {/* description */}
            <p className="w-full text-sm font-normal tracking-wide py-4">
              Hands-on training in tech and digital skills-empowering the next
