...
export default function ReservationNavigationComponent({
  step,
  setStep,
}: ReservationNavigationComponentProps) {
  return (
    <nav
      className={
        "w-full h-[99px] absolute top-0 flex items-center bg-(--navigation-gray) px-2.5 pt-12"
      }
    >
      <button
        type="button"
      ...
      >
        <span className="w-8 h-8 text-left flex justify-center items-center">
          <ChevronLeft />
        </span>
      </button>
